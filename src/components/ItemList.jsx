...
function ItemList(props) {
    ...
    const onDeleteItem = () => {
        if (props.isStandard) {
            ...
            const afterDeletion = props.auctions.filter(
                game => game.id !== target
            )
                ...
                if (json.status) {
                    ...
                    if (props.isStandard) {
                        if (json[0].price != null) {
                            ...
                            setRecoverError('Não é possível importar os itens de um leilão em um anúncio padrão.')
                        }
                        ...
                        if (json[0].starting_price != null) {
                            ...
                            setRecoverError('Não é possível importar os itens de um anúncio padrão em um leilão.')
                        }
                    }
                }
    ...
    return (
        <>
            <Grid
                ...
                sx={{ mt: 1 }}
            >
                <Typography variant="h6" sx={{ mt: 2, mb: 1, textAlign: "center" }} component="div">
...

            {
                ...
                ?   props.userData.boardgames.length === 0       
                        ?   <Grid
                                ...
                                alignItems="center"
                            >
                                <Button size="small" onClick={ openRecoverDialog }>Importar itens</Button>
                            </Grid>
                        :   <></>
            ...
            >
                ...
                >
                    ...
                    <Typography variant="body1" sx={{ mt: 2, mb: 2, ml: 2, fontSize: "14px", }} component="div">
                            ...
                            props.isStandard
                                ?   editType === "Apenas Venda" || editType === "Venda ou Troca"
                                    ?   <TextField 
                                            ...
                                            variant="standard"
                                            value={ editPrice }
                                            onChange={ event => priceValidation(event.target.value, 'editPrice') } 
                                ...
                                :   <Grid
                                    ...
                                    >
                                        <TextField 
                                            ...
                                            onChange={ event => priceValidation(event.target.value, 'editStartingPrice') } 
                                            inputProps={ inputProps }
                                            sx={{ mt: 1 }}
                                            fullWidth
                                        />
                                        <TextField 
                                            ...
                                            variant="standard"
                                            value={ editIncrement }
                                            onChange={ event => priceValidation(event.target.value, 'editIncrement') } 
                                            inputProps={ inputProps }
                                            sx={{ mt: 1 }}
                                            fullWidth
                                        />
            ...
            >
                <DialogTitle id="alert-dialog-title">
                    ...
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Ao informar o ID, você poderá importar os jogos referentes a um anúncio já enviado ao Bazar.
                        </DialogContentText>
                        <TextField
                            autoFocus
                            margin="dense"
                        ...
                        />
                        {
                            recoverLoading
                                ...
                                :   recoverError.length > 0
                                    ?   <Alert severity="error" sx={{ mt: 2, mb: 1 }}>{ recoverError }</Alert>
                                    :   <></>
                        }
                    </DialogContent>
                <DialogActions>
